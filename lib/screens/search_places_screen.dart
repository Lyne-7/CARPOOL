...
import 'package:carpool_users/widgets/place_prediction_tile.dart';
...
class _SearchPlacesScreenState extends State<SearchPlacesScreen> {
  ...
  findPlaceAutoCompleteSearch(String inputText) async {
    ...
    if(inputText.length > 1){
      String urlAutoCompleteSearch = 'https://maps.googleapis.com/maps/api/place/autocomplete/json?input=$inputText&key=$mapKey&components=country:KE';
